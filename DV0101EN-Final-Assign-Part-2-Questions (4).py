...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        # use groupby to create relevant data for plotting
        average_sales = recession_data.groupby('Vehicle_Yype')['Automobile_Sales'].mean().reset_index()                           
        R_chart2  = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_sales = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobiles_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure = px.bar(
                unemp_sales,
                x = 'unemployment_rate',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        total_monthly_sales = data.groupby(['Year', 'Month'])['Automobiles_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(
            figure=px.line(
                total_monthly_sales,
                x = 'Month',
...
# Plot 3 bar chart for average number of vehicles sold during the given year
        avr_vdata=yearly_data.groupby('Year')['Automobiles_Sales'].mean().reset_index()
        Y_chart3 = dcc.Graph(
            figure=px.bar(
                avr_vdata,
                x = 'Year',
